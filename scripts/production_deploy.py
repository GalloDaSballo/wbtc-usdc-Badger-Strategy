...
def deploy_vaults_and_strategies(
    ...
    # strat_logic = StrategyQuickBadgerWBtcUsdc.deploy({"from": dev})
    strat_logic = StrategyQuickBadgerWBtcUsdc.at("0x7AfB2E386b7990507009f81B3c486c8C596501a4")
    time.sleep(sleep_between_tx)
